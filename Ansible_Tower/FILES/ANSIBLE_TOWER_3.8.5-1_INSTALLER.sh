...
echo '
                                ANSIBLE-TOWER 3.8.5-1 INSTALLER FOR RHEL 7.x AND RHEL 8.x
...
echo "
                        ...
                        6. This install was tested with:
                          ...
                          * Ansible Tower 3.8.5-1 https://releases.ansible.com/ansible-tower/setup-bundle/ansible-tower-setup-bundle-latest.el8.tar.gz (will auto download)
                          * Red Hat subscriber channels:
...
cd ~/Downloads
echo "***************************************************************************"
echo "SET SELINUX TO PERMISSIVE FOR THE INSTALL AND CONFIG OF Ansible Tower 3.8.5-1"
echo "***************************************************************************"
...
then 
echo '****************************************************************'
echo 'Getting, Expanding, and installing Ansible Tower 3.8.5-1 for RHEL7'
echo '****************************************************************'
mkdir ~/Downloads
cd ~/Downloads
wget https://releases.ansible.com/ansible-tower/setup-bundle/ansible-tower-setup-bundle-3.8.5-1.tar.gz
tar -zxvf ~/Downloads/ansible-tower-setup-bundle-3.8.5-1.tar.gz 
cd ~/Downloads/ansible-tower-setup-bundle-3.8.5-1
dnf localinstall -y --skip-broken ~/Downloads/ansible-tower-setup-bundle-3.8.5-1/bundle/el7/repos/ansible-tower-dependencies/*.rpm  --best --allowerasing
sleep 2
echo " "
echo " " 
cd 
...
read ADMINPASSWORD
export $ADMINPASSWORD
sed -i 's/admin_password='"''"'/admin_password='"'"$ADMINPASSWORD"'"'/g' ~/Downloads/ansible-tower-setup-bundle-3.8.5-1/inventory
sed -i 's/pg_password='"''"'/pg_password='"'"$ADMINPASSWORD"'"'/g' ~/Downloads/ansible-tower-setup-bundle-3.8.5-1/inventory
sed -i 's/automationhub_admin_password='"''"'/automationhub_admin_password='"'"$ADMINPASSWORD"'"'/g' ~/Downloads/ansible-tower-setup-bundle-3.8.5-1/inventory
sed -i 's/automationhub_pg_password='"''"'/automationhub_pg_password='"'"$ADMINPASSWORD"'"'/g' ~/Downloads/ansible-tower-setup-bundle-3.8.5-1/inventory
...
then
echo '****************************************************************'
echo 'Getting, Expanding, and installing Ansible Tower 3.8.5-1 for RHEL8'
echo '****************************************************************'
mkdir ~/Downloads
cd ~/Downloads
wget https://releases.ansible.com/ansible-tower/setup-bundle/ansible-tower-setup-bundle-3.8.5-1.tar.gz
tar -zxvf ~/Downloads/ansible-tower-setup-bundle-3.8.5-1.tar.gz 
cd ~/Downloads/ansible-tower-setup-bundle-3.8.5-1
dnf localinstall -y --skip-broken ~/Downloads/ansible-tower-setup-bundle-3.8.5-1/bundle/el8/repos/ansible-tower-dependencies/*.rpm --best --allowerasing
sleep 2
echo " "
echo " "

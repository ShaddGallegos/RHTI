...
echo '
                                ANSIBLE-TOWER 3.7.1-1 INSTALLER FOR RHEL 7.x AND RHEL 8.x
...
echo "
                        ...
                        6. This install was tested with:
                          ...
                          * Ansible Tower 3.7.1-1 https://releases.ansible.com/ansible-tower/setup-bundle/ansible-tower-setup-bundle-latest.el8.tar.gz
                          * Red Hat subscriber channels:
...
cd /root/Downloads
echo "***************************************************************************"
echo "SET SELINUX TO PERMISSIVE FOR THE INSTALL AND CONFIG OF Ansible Tower 3.7.1-1"
echo "***************************************************************************"
...
then 
echo '****************************************************************'
echo 'Getting, Expanding, and installing Ansible Tower 3.7.1-1 for RHEL7'
echo '****************************************************************'
mkdir /root/Downloads
cd /root/Downloads
...
read ADMINPASSWORD
export $ADMINPASSWORD
sed -i 's/admin_password='"''"'/admin_password='"'"$ADMINPASSWORD"'"'/g' /root/Downloads/ansible-tower-setup-bundle-3.7.1-1/inventory
sed -i 's/pg_password='"''"'/pg_password='"'"$ADMINPASSWORD"'"'/g' /root/Downloads/ansible-tower-setup-bundle-3.7.1-1/inventory
sed -i 's/rabbitmq_password='"''"'/rabbitmq_password='"'"$ADMINPASSWORD"'"'/g' /root/Downloads/ansible-tower-setup-bundle-3.7.1-1/inventory
echo " "
echo " "
cd /root/Downloads/ansible-tower-setup-bundle-3.7.1-1
sh setup.sh
...
then
echo '****************************************************************'
echo 'Getting, Expanding, and installing Ansible Tower 3.7.1-1 for RHEL8'
echo '****************************************************************'
mkdir /root/Downloads
cd /root/Downloads
wget https://releases.ansible.com/ansible-tower/setup-bundle/ansible-tower-setup-bundle-3.7.1-1.tar.gz
...
tar -zxvf /root/Downloads/ansible-tower-setup-bundle-3.7.1-1.tar.gz 
cd /root/Downloads/ansible-tower-setup-bundle-3.7.1-1
dnf localinstall -y --skip-broken /root/Downloads/ansible-tower-setup-bundle-3.7.1-1/bundle/el8/repos/ansible-tower-dependencies/*.rpm --best --allowerasing
sleep 2
echo " "
echo " "
echo 'What would you like your default Ansible Tower user "admin" password to be?'
